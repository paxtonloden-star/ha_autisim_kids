...
class AutismKidsCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_send_timer_notification(self, label: str) -> None:
        ...
        await self.hass.services.async_call(
            ...
            "create",
            {
                "title": self.entry.options.get(CONF_TIMER_NOTIFICATION_TITLE, DEFAULT_TIMER_NOTIFICATION_TITLE),
    ...
    async def async_send_request_notification(self, request_label: str) -> None:
        ...
        await self.hass.services.async_call(
            ...
            "create",
            {
                "title": self.entry.options.get(CONF_REQUEST_NOTIFICATION_TITLE, DEFAULT_REQUEST_NOTIFICATION_TITLE),
