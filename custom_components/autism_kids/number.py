...
class AutismKidsCustomTimerNumber(
    CoordinatorEntity[AutismKidsCoordinator], RestoreNumber, NumberEntity
):
    ...
    async def async_added_to_hass(self) -> None:
        ...
        if last_number_data is not None:
            ...
            self.coordinator.async_set_custom_timer_minutes(
    ...
    def native_value(self) -> float:
        return float(
            self.coordinator.data.get("custom_timer_minutes", self._attr_native_value)
        )
